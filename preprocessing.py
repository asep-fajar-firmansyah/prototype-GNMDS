...
pkl_clusters, pkl_documents, pkl_summaries, pkl_y = data

print(len(pkl_clusters))
print(len(pkl_documents))
print(len(pkl_summaries))
print(len(pkl_y))

total_documents = 0
cluster = 0
for doc_cluster in pkl_documents:
  cluster +=1
  print('Cluster:', cluster, 'Amount of Doc:', len(doc_cluster))
  no = 0
  for sentences in doc_cluster:
    no +=1
    print('Doc:', no, 'Amount of Sentences:', len(sentences))
  total_documents += len(doc_cluster)
print(total_documents)

total_sentences = 0
for cluster_sentences in pkl_clusters:
  total_sentences += len(cluster_sentences)
print(total_sentences)

sentences = []
for cluster_sentences in pkl_clusters:
  for cluster_sentence in cluster_sentences:
    sentences.append(cluster_sentence)
len(sentences)
